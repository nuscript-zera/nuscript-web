  ...
  const workflowSteps = [
    {
      ...
      description:
        "Our team reviews clinical documentation and extracts diagnoses, procedures, and key clinical details to generate accurate ICD-10, CPT, and HCPCS code suggestions for each encounter.",
    },
    {
      number: "02",
      title: "Expert Coding",
      description:
        "Certified medical coding specialists review and validate every code to ensure accuracy, adherence to payer requirements, and compliance with specialty-specific guidelines.",
    },
    {
      number: "03",
      title: "Quality Assurance",
      description:
        "Every coded encounter is audited to verify that billed services are fully supported in the chart, with documentation gaps identified and clarifications prompted when needed.",
    },
  ];
      ...
      <div className="relative">
        <GenericHero
          title={
            <>
              Accurate Coding,
              <span className="block text-[#6200EA]">Faster Revenue</span>
            </>
          }
          subtitle="Medical Coding Services"
          description="NuScript's medical coding services combine AI-enhanced workflows with the judgment of experienced, certified coding specialists to deliver accurate, compliant codes and stronger documentation integrity."
        ...
        <section className="max-w-7xl mx-auto px-6 lg:px-8 py-24">
          <div className="text-center mb-16">
            ...
            <p style={{ fontWeight: 400, fontSize: "16px", lineHeight: "1.6" }} className="text-gray-700 max-w-2xl mx-auto">
              A structured approach combining technology with human expertise for optimal results.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {workflowSteps.map((step, idx) => (
              ...
              >
                <div className="text-4xl font-semibold text-[#6200EA] mb-4" style={{ fontWeight: 600 }}>
                  {step.number}
                </div>
                <h3 style={{ fontWeight: 600, fontSize: "20px" }} className="text-[#222733] mb-3">
                  {step.title}
                </h3>
        ...
        <section className="max-w-7xl mx-auto px-6 lg:px-8 py-24">
          <CTABox
            ...
            description="See how NuScript's coding services can accelerate your revenue cycle while maintaining the highest standards of compliance and documentation integrity."
            primaryButtonText="Schedule a Consultation"
            secondaryButtonText="Talk With Our Team"
          />
        </section>
