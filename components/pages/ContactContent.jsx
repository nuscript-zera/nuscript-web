...
export default function ContactContent() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(
        "Failed to open email client. Please email us directly at hello@nuscript.net."
      );
    } finally {
  ...
  const contactInfo = [
    {
      ...
      title: "Email",
      details: [
        "General Inquiries: hello@nuscript.net",
        "Opportunities: careers@nuscript.net",
      ],
    ...
    },
    {
      ...
      details: ["5900 Balcones Drive, Ste 11995", "Austin, TX 78731"],
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16 -mt-16 relative z-10">
        <div className="grid md:grid-cols-3 gap-6">
          {contactInfo.map((info, index) => (
            ...
            >
              <div
                className={`w-12 h-12 rounded-xl bg-gradient-to-br ${info.gradient} flex items-center justify-center mb-4`}
              >
            ...
            >
              <div>
                <span
                  ...
                  className="inline-block px-3 py-1.5 rounded-full bg-blue-100 text-[#2563eb] mb-6"
                >
                  Get Started
                </span>
              ...
              >
                Let&apos;s discuss how NuScript can reduce your documentation
                burden, improve coding quality, and accelerate your revenue cycle.
              </p>
            </motion.div>
