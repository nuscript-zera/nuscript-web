...
export default function MedicoLegalContent() {
  const workflowSteps = [
    {
      number: "01",
      title: "Secure Audio Receipt",
      description:
        "Dictations from independent medical examinations, depositions, and legal proceedings are received through our HIPAA-compliant, encrypted platform with full chain-of-custody tracking.",
    },
    {
      number: "02",
      title: "Verbatim Transcription",
      description:
        "Experienced medico-legal transcriptionists transcribe every word exactly as dictated — no paraphrasing, no summarizing, no rearranging. Legal proceedings depend on exact wording.",
    },
    {
      number: "03",
      title: "Legal QA Review",
      description:
        "Senior QA auditors with medico-legal expertise perform word-for-word verification, validating attorney names, case citations, legal terminology, and medical findings against our legal knowledge base.",
    },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-teal-50/20 to-white">
      ...
      <div className="relative">
        <GenericHero
          title={
            <>
              ...
              <span className="block text-[#2563EB]">Where Every Word Matters</span>
            </>
          }
        ...
        <section className="max-w-7xl mx-auto px-6 lg:px-8 py-24">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {workflowSteps.map((step, idx) => (
              ...
              >
                <div className="text-4xl font-semibold text-[#2563EB] mb-4" style={{ fontWeight: 600 }}>
                  {step.number}
                </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
              {documentTypes.map((doc, idx) => (
                ...
                >
                  ...
                  <p style={{ fontWeight: 500, fontSize: "14px" }} className="text-[#222733]">
                    {doc}
                  </p>
                </motion.div>
              ))}
        ...
        <section className="max-w-7xl mx-auto px-6 lg:px-8 py-24">
          <div className="text-center mb-16">
            <h2 style={{ fontWeight: 600, fontSize: "36px", lineHeight: "1.3" }} className="text-[#222733] mb-6">
              Why Choose NuScript for Medico-Legal
            </h2>
          </div>
