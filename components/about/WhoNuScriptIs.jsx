      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-100/80 border border-blue-200/50 mb-6">
            <span style={{ fontWeight: 500, fontSize: "13px" }} className="text-blue-700">
              Our Foundation
            </span>
          </div>
          <h3 style={{ fontWeight: 500, fontSize: "40px", lineHeight: "1.2" }} className="text-slate-900 mb-6">
            Who NuScript Is
          </h3>
          <p
            style={{ fontWeight: 400, fontSize: "17px", lineHeight: "1.8" }}
            className="text-slate-600 max-w-3xl mb-8"
          >
            NuScript was founded after decades of working alongside physicians,
            practice leaders, and hospital teams who needed clearer documentation
            and more predictable revenue. Today, the company serves providers
            across a wide range of specialties and care settings.
          </p>
        </motion.div>
        ...
        >
          <h4 style={{ fontWeight: 500, fontSize: "16px" }} className="text-slate-900 mb-6">
            Specialties Served
          </h4>
