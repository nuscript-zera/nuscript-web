  ...
  const capabilities = [
    {
      ...
      description:
        "Built on a long history in medical transcription and AI-assisted scribing to capture every encounter accurately and compliantly.",
    },
    {
      title: "Optimized Medical Coding & RCM",
      description:
        "Advanced methodologies and technology to maximize reimbursement, minimize denials, and accelerate cash flow.",
    },
    {
      title: "Integrated Technology & Support",
      description:
        "Streamlined workflows across the revenue cycle with a single, reliable offshore partner.",
    },
  ];
  ...
  return (
    <section className="relative py-32 bg-white overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute top-20 right-20 w-3 h-3 rounded-full bg-blue-400/40"
      />
      <motion.div
        animate={{ y: [0, 20, 0], opacity: [0.4, 0.7, 0.4] }}
        transition={{ duration: 8, repeat: Infinity, ease: "easeInOut", delay: 1 }}
        className="absolute bottom-32 left-32 w-2 h-2 rounded-full bg-teal-400/50"
      />
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        <motion.div
          ...
          className="mb-16"
        >
          <h3 style={{ fontWeight: 500, fontSize: "36px", lineHeight: "1.2" }} className="text-slate-900 mb-12">
            What NuScript Does
          </h3>
        </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {capabilities.map((cap, idx) => (
            ...
            >
              ...
              <h4 style={{ fontWeight: 500, fontSize: "18px" }} className="text-slate-900 mb-2">
                {cap.title}
              </h4>
