    ...
    <section className="relative py-32 bg-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          >
            NuScript&apos;s work is grounded in core values of integrity,
            accountability, collaboration, and excellence. These values show up
            in how teams are trained, how quality is measured, and how long-term
            client relationships are built and maintained.
          </p>
        </motion.div>
          ...
          {values.map((value, idx) => {
            ...
            return (
              ...
              >
                ...
                <h4 style={{ fontWeight: 500, fontSize: "20px" }} className="text-slate-900 mb-4">
                  {value.title}
                </h4>
