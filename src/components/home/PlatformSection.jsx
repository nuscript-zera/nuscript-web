        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
            ...
            <p style={{ fontWeight: 400, fontSize: '18px', lineHeight: '1.6' }} className="text-gray-400 mb-10">
              NuScript brings together deep healthcare domain expertise and AI-enhanced 
              workflows to deliver accurate documentation, compliant coding, and optimized 
              revenue cycle management — all from a single, trusted partner.
            </p>
