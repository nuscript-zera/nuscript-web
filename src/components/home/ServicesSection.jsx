...
const services = [
  {
    ...
    description: "Medical transcription and medical scribing services backed by 25+ years of expertise. Our team of skilled clinical documentation editors delivers accurate, chart-ready notes with same-day turnaround.",
  ...
  },
  {
    ...
    description: "Certified coders ensure accurate ICD-10, CPT, and HCPCS code assignment aligned with U.S. clinical and billing standards, strengthening documentation integrity and payer compliance.",
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <p style={{ fontWeight: 400, fontSize: '18px', lineHeight: '1.6' }} className="text-slate-600">
            NuScript's expert teams handle every step — from the moment a clinician speaks to when revenue hits your account.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {services.map((service, index) => (
            ...
            >
              <Link to={createPageUrl(service.page)} className="block h-full no-underline">
