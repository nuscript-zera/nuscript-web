  ...
  const workflowSteps = [
    {
      ...
      description: 'Accurate, complete clinical documentation ensures no billable service is missed. Our documentation teams feed directly into clean charge capture.'
    },
    {
      number: '02',
      title: 'Claims Processing',
      description: 'Intelligent claims submission with verification of completeness and compliance before sending to payers, reducing rejections and accelerating payment.'
    },
    {
      number: '03',
      title: 'AR Management',
      description: 'Real-time visibility into accounts receivable with systematic follow-up protocols, denial management, and priority escalation for aging claims.'
    }
  ];
      ...
      <div className="relative">
        ...
        <section className="max-w-7xl mx-auto px-6 lg:px-8 py-24">
          <div className="text-center mb-16">
            <h2 style={{ fontWeight: 700, fontSize: '36px', lineHeight: '1.3' }} className="text-[#222733] mb-6">The Complete RCM Workflow</h2>
            <p style={{ fontWeight: 400, fontSize: '16px', lineHeight: '1.6' }} className="text-gray-700 max-w-2xl mx-auto">Streamlined processes at every step of your revenue cycle.</p>
          </div>
        ...
        <section className="bg-gradient-to-br from-violet-50 to-blue-50 py-24">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 style={{ fontWeight: 700, fontSize: '36px', lineHeight: '1.3' }} className="text-[#222733] mb-6">Why Healthcare Organizations Choose NuScript RCM</h2>
            </div>
