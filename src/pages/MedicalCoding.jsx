  ...
  const workflowSteps = [
    {
      ...
      description: 'Our team reviews clinical documentation and extracts diagnoses, procedures, and key clinical details to generate accurate ICD-10, CPT, and HCPCS code suggestions for each encounter.'
    },
    {
      number: '02',
      title: 'Expert Coding',
      description: 'Certified medical coding specialists review and validate every code to ensure accuracy, adherence to payer requirements, and compliance with specialty-specific guidelines.'
    },
    {
      number: '03',
      title: 'Quality Assurance',
      description: 'Every coded encounter is audited to verify that billed services are fully supported in the chart, with documentation gaps identified and clarifications prompted when needed.'
    }
  ];
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {workflowSteps.map((step, idx) => (
              <motion.div key={idx} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: idx * 0.1 }}
                ...
                <div className="text-4xl font-bold text-[#6200EA] mb-4" style={{ fontWeight: 800 }}>{step.number}</div>
